...
def stats_menu_kb(lang: str) -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text=t("btn_stats_daily", lang),
                    callback_data="stats:daily",
                )
            ],
            [
                InlineKeyboardButton(
                    text=t("btn_stats_weekly", lang),
                    callback_data="stats:weekly",
                )
            ],
            [
                InlineKeyboardButton(
                    text=t("btn_stats_yearly", lang),
                    callback_data="stats:yearly",
                )
            ],
            [
                InlineKeyboardButton(
                    text=t("btn_stats_top", lang),
                    callback_data="stats:top",
                )
            ],
            [
                InlineKeyboardButton(
...
def report_reasons_kb(lang: str, thread_id: int) -> InlineKeyboardMarkup:
    reasons = [
    ...
    rows = [
        [
            InlineKeyboardButton(
                text=t(key, lang),
                callback_data=f"report_reason:{thread_id}:{canonical}",
            )
        ]
