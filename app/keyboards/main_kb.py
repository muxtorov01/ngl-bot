...
def main_menu_kb(
    ...
    if is_premium:
        ...
        rows.append(
            [
                InlineKeyboardButton(
                    text=t("btn_blocked", lang),
                    callback_data="menu:blocks",
                )
            ]
        )
    else:
...
def link_kb(lang: str, token: str) -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                InlineKeyboardButton(
                    text=t("btn_regenerate_link", lang),
                    callback_data="link:regenerate",
                )
            ],
            [
                InlineKeyboardButton(
